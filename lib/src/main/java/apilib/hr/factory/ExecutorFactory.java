...
public class ExecutorFactory {
	private static final Logger log = LogManager.getLogger(ExecutorFactory.class);
	...
	public static void init() {
		try {
			...
			corePoolSize = 1;
			maxPoolSize = 1;
			boundQueue = ParameterConstant.IS_MAX_TASK_QUEUE;
		}
		
		try {
			if (boundQueue == ParameterConstant.IS_MAX_TASK_QUEUE) {
